...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == TRUE){
    ...
    echo "<br><a href='index.html'>Registrarme</a>";
    header("Location: login.html"); // redirige  a la pagina de login si el usuario quiere ingresar sin iniciar sesion
...
if($now > $_SESSION['expire']){
    session_destroy();
    header("Location: login.html"); // redirige a la pagina de login, modifica la url a tu conveniencia
